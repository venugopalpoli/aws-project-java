...
public class RedisMemoryDBDemo {
	...
	private void loadProperties() throws IOException {
		...
		//FileInputStream fis = new FileInputStream(new File("/MemoryDB_for_Redis_config.properties"));
		properties.load(getClass().getResourceAsStream("/MemoryDB_for_Redis_config.properties"));
